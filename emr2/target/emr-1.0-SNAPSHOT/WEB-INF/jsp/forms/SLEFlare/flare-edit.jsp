...
<div class="content-wrap">
	<div class="wrapper prospects">
		...
		<form:form action="update_sle_flare.it?pid=${patient.getId() }&fid=${form.id }" method="post" commandName="form">
...
<br><br><br><br>
			<section>
				<ul class="btnForm">
					...
					<a href="view_sle_flare_form.it?pid=${patient.getId() }&fid=${form.id}"><span class="btn"><input type="button"
