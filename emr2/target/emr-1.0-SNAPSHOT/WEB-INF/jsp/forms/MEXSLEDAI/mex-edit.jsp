...
<div class="content-wrap">
	<div class="wrapper prospects">
		...
		<form:form action="update_MEXSLEDAI.it?pid=${patient.getId() }&fid=${form.id }" method="POST" commandName="form">		
...
<td class="pro">Seizure</td>
			...
			<tr>
				<td class="pro1"><select name="neurologicalDisorder" >
						<option value="${form.neurologicalDisorder }">${form.neurologicalDisorder }</option>
		...
		<td class="pro">Mononeuritis</td>
			...
			<tr>
				<td class="pro"><select name="renal" >
						<option value="${form.renal }">${form.renal }</option>
						<option value="1">1</option>
						<option value="2">2</option>
						<option value="3">3</option>
						<option value="4">4</option>
			...
			<tr>
				<td class="pro"><select name="vasculitis" >
						<option value="${form.vasculitis }">${form.vasculitis }</option>
						<option value="1">1</option>
						<option value="2">2</option>
						<option value="3">3</option>
			...
			<tr>
				<td class="pro"><select name="hemolysis" >
						<option value="${form.hemolysis }">${form.hemolysis }</option>
						<option value="1">1</option>
						<option value="2">2</option>
			...
			<tr>
				<td class="pro"><select name="myositis" >
						<option value="${form.myositis }">${form.myositis }</option>
						<option value="1">1</option>
						<option value="2">2</option>
						<option value="3">3</option></select>
				Myositis (3)</td>
			...
			<tr>
				<td class="pro"><select name="arthritis" >
						<option value="${form.arthritis }">${form.arthritis }</option>
						<option value="1">1</option>
			...
			<tr>
				<td class="pro"><select name="cutaneous" >
						<option value="${form.cutaneous }">${form.cutaneous }</option>
						<option value="1">1</option>
						<option value="2">2</option></select>
				Cutaneous (2)</td>
			...
			<tr>
				<td class="pro"><select name="serositis" >
						<option value="${form.serositis }">${form.serositis }</option>
						<option value="1">1</option>
						<option value="2">2</option></select>
				Serositis (2)</td>
			...
			<tr>
				<td class="pro"><select name="fever" >
						<option value="${form.fever }">${form.fever }</option>
			...
			<tr>
				<td class="pro"><select name="leukopenia" >
						<option value="${form.leukopenia }">${form.leukopenia }</option>
						<option value="1">1</option></select>
			...
			<section>
				<ul class="btnForm">
					...
					<a href="view_MEXSLEDAI.it?pid=${patient.getId() }&fid=${form.id}"><span class="btn"><input type="button"
