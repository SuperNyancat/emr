...
<jsp:include page="../../headers/doctor-header.jsp">
	<jsp:param name="title" value="Rodnan Skin Score Records" />
...
<c:choose>
	...
	<ul class="ctrlBtn">
		<li><span class="btn"><a href="rodnan_assemble.it?id=${patient.getId() }"><input type="button" value="New Record" class="btnNew"></a></span></li>
...
<div class="content-wrap">	
	<div class="wrapper prospects">
		...
		<div style="background:goldenrod">
				<br><p class="titles" style="color:white;">Modified Rodnan Skin Score</p><br>		
		</div>
			<div class="tableSearch clrfix">
				<section>
				
				
				 <form:form commandName="patient" action="rodnan_search.it" method="GET">
...
<table class ="tablecontent3">	
		...
		<tr>
			...
			<c:forEach items="${rodnanForms }" var="form">
			<tr>
				<td><div class="blue"></div></td>
				<td class="pro"><a href="rodnan_view.it?pid=${patient.getId()}&fid=${form.getId()}">${ form.getRevisionHistory().getDateCreated()}</a></td>
