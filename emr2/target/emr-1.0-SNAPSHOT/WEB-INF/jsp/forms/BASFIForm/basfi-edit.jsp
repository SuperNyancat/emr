		...
		<div class="tab-content">
			...
			<div class="right">
				...
				<br/><br/>
					...
					<br><br/>
					<form:form action="update_BASFI.it?pid=${patient.getId()}&fid=${form.getId()}" method="post" commandName="form">
			...
			<section>
				<ul class="btnForm">
					...
					<a href="view_basfi.it?pid=${patient.getId() }&fid=${form.id}"><span class="btn"><input type="button"
