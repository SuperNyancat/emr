...
<c:choose>
	<c:when test="${nurse != null }">
		<jsp:include page="../../headers/nurse-header.jsp">
			<jsp:param name="title" value="View Patient History" />
...
<!-- <ul class="ctrlBtn">
	<li><span class="btn">
		<form:form commandName="form" action="ih_edit.it" method="GET">
...
<li>If yes, list: ${form.pastMedications.clinicalTrials_details}</li><br>
							...
							<br><h1>Activities of Daily Living</h1>		
								...
								<table border="1" class="navigation" style="margin:0px auto;">
									<tr>
										<th align="center" colspan="2"><b>Because of health problems, do you have difficulty:</b></td>
							...
							<ul class="ctrlBtn listSpace">
									<li><span class="btn"><a href="ih_print.it?pid=${patient.getId() }&fid=${form.getId()}"><input type="button" value="Print" class="btnEdit" style="right-align"></a></span></li>
								</ul>
