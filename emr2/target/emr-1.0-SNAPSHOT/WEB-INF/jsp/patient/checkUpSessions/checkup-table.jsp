...
<div class="pageCtrl">
<ul class="ctrlBtn">
	<li><a href="check_up_sessions_assembler.it?id=${patient.getId() }"><span class="btn"><input type="button" value="New Record" class="btnNew"></span></a></li>
...
<div class="content-wrap">	
	<div class="wrapper prospects">
			...
			<div class="tableSearch clrfix">
					...
					<table class="tablecontent3">
						<tr>
							...
							<th class="phn"><a href="">Symptoms</a></td>
		...
		<tr>
			...
			<c:forEach items="${checkUpSessions }" var="form">
				<tr>
					<td><div class="blue"></div></td>
					<td class="pro"><a href="view_checkup_session.it?pid=${patient.getId() }&fid=${form.getId()}" title="">${form.getRevisionHistory().getDateCreated() }</a></td>
					<td class="phn">${form.getSymptoms() }</td>		
				</tr>
