					...
					$("#btnSaveNote")
						.click(
							function() {
								...
								$.ajax({
									type: "POST",
									url: "addNote?id=" + $contactId + "&text=" + $noteText,
									success: function(){
										window.location = "view?id=" + $contactId + "#noteText";
									},
							...
							.click(
									function() {
										showChooseItemDialog($dialog,
												"#formCancel",
												"Are you sure you want to cancel editing this contact?");
										return false;
									});
						...
						.click(
							function(event) {
								...
								if($text === '') {
									...
									$.ajax({
										type: "POST",
										url: "editNote?id=" + $contactId + "&noteid=" + $noteId + "&text=" + $text
									});
								}
							});
