...
<div class="content-wrap">
	<div class="wrapper prospects">
		...
		<div class="right">
			<form:form action="pasi_edit.it?id=${patient.id }" method="post" commandName="form">
			<div>
			...
			<ul>
				...
				<li>
					<b>Hospital No.:</b>&nbsp&nbsp&nbsp <form:input path="hospitalNumber" value="${form.getHospitalNumber()}"/> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
				</li><br><br>
			</ul>
			...
			<h4>Psoriasis Area and Severity Index</h4>	
				<div class="">
					...
					<table border="1px" class="navigation" style="margin:0px auto;">
						...
						<tr>
							<td><b>Erythema</b></td> <form:hidden path="pasiDetails.identifier" value="Erythema"/>
							<td align="center">
							...
							<tr>
							<td><b>Induration/Thickness</b></td> <form:hidden path="pasiDetails.identifier" value="Induration/Thickness"/>
							<td align="center">
							...
							<tr>
							<td><b>Scaling</b></td> <form:hidden path="pasiDetails.identifier" value="Scaling"/>
							<td align="center">
						...
						<tr>
							<td align="center"><b>Lesion Score Sum (A)</b></td> <form:hidden path="pasiDetails.identifier" value="sumA"/>
							<td>*Autocomputed*</td>
							<td>*Autocomputed*</td>
							<td>*Autocomputed*</td>
							<td>*Autocomputed*</td>
					...
					<table border="1px" class="navigation" style="margin:0px auto;">
						...
						<tr>
							<td align="center"><b></b></td> <form:hidden path="pasiDetails.identifier" value="area"/>
							<td align="center">
						...
						<tr>
							<td align="center"><b>Subtotals (C)</b></td> 
							<td>*Autocomputed*</td>
							<td>*Autocomputed*</td>
							<td>*Autocomputed*</td>
							<td>*Autocomputed*</td>
						...
						<tr>
							<td align="center"><b>Totals (D)</b></td>
							<td>*Autocomputed*</td>
							<td>*Autocomputed*</td>
							<td>*Autocomputed*</td>
							<td>*Autocomputed*</td>
					...
					<ul align="center">
						<li>
							<b>PASI Score:</b> &nbsp&nbsp&nbsp *Autocomputed* &nbsp&nbsp&nbsp
						</li><br><br>
					</ul>
