...
<html lang="en">
<head>
	<title>Systemic Sclerosis Flow Sheet Records</title>
	<meta charset="utf-8">
</head>
...
<c:choose>
	...
	<ul class="ctrlBtn">
		<li><span class="btn"><a href="SS_flowsheet_form_assembler.it?id=${patient.getId() }"><input type="button" value="New Record" class="btnNew"></a></span></li>
...
<div class="content-wrap">	
	<div class="wrapper prospects">
		...
		<div style="background:goldenrod">
				<br><p class="titles" style="color:white;">Systemic Sclerosis Flow Sheet</p><br>		
		</div>
			<div class="tableSearch clrfix">
				<section>
					  <form:form commandName="patient" action="search_ss_flowsheet.it" method="GET">
		...
		<tr>
			...
			<c:forEach items="${ssForms }" var="form">
				<tr>
				<td><div class="blue"></div></td>
				<td class="pro"><a href="view_SS_flowsheet.it?pid=${patient.getId()}&fid=${form.getId()}">${ form.getRevisionHistory().getDateCreated()}</a></td>
				
				<td class="phn">${form.getSkinScore() }</td>				
