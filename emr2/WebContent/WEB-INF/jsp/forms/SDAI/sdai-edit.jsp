...
<div class="content-wrap">
	<div class="wrapper prospects">
		...
		<div class="tab-content">
			...
			<div class="right">
			<p class="titles">Simple Disease Activity Index</p><br>	
				<form:form action="sdai_update.it?pid=${patient.getId()}&fid=${form.getId()}" method="post" commandName="form">
			...
			<section>
				<ul class="btnForm">
					...
					<a href="view_sdai.it?pid=${patient.getId() }&fid=${form.id}"><span class="btn"><input type="button"
