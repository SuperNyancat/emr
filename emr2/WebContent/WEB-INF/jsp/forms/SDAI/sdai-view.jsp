...
<ul class="ctrlBtn">
	<li><span class="btn">
		<form:form commandName="form" action="sdai_table.it" method="GET">
			<form:hidden path="id" value="${patient.id }" />
			<input type="submit" value="Back To Forms" class="btnFet" />
		</form:form>
	</span></li>
	<li><span class="btn">
		<form:form commandName="form" action="sdai_edit.it" method="GET">
	...
	<div align="center" id="welcomeDiv"  style="display:none; background:red; padding-left:20px" class="answer_list" >
		...
		<span class="btn">
			<form:form commandName="form" action="sdai_delete.it" method="GET">
				<form:hidden path="patient.id" value="${patient.id }" />
				<form:hidden path="id" value="${form.id }" />
			...
			<div class="tab-content">
				<section class="settingBody clrfix">		
					<div class = "left">
						...
						<div class="right">
							<div>
								<br><p class="titles" style="color:goldenrod">Simple Disease Activity Index</p><br>		
							</div>
							<br><br>					
								...
								<c:forEach varStatus="i" begin="0" end="${fn:length(form.joints)-1 }" >
									...
									<table border="1px" class="navigation" style="margin:0px auto;">
									<tr>
										<td colspan="3" style="text-align:center">How to score the SDAI</td>	
									</tr>
									...
									<tr>
										...
										<td>(0-10)</td>
										<td style="text-align:center">${form.cReactiveProtein }</td>
									</tr>

									<tr>
										<td><b>SDAI score</b></td>
										<td>(0-86)</td>
										<td style="text-align:center">${form.SDAIScore }</td>
									</tr>	
									<tr>
										<td><b>SDAI Interpretation</b></td>
										<td></td>
										<td style="text-align:center">${form.SDAIScoreInterpretation }</td>
									</tr>								
									</table>	
									<br><br>									
									...
									<table border="1px" class="navigation" style="margin:0px auto;">
									<tr>
										<td colspan="2"><b>SDAI Score Interpretation</b></td>
									</tr>
