...
<jsp:include page="../../headers/doctor-header.jsp">
	<jsp:param name="title" value="CDAI Records" />
...
<c:choose>
	...
	<ul class="ctrlBtn">
		<li><span class="btn"><a href="cdai_assemble.it?id=${patient.getId() }"><input type="button" value="New Record" class="btnNew"></a></span></li>
...
<div class="content-wrap">	
	<div class="wrapper prospects">
		...
		<div style="background:goldenrod">
				<br><p class="titles" style="color:white;">Clinical Disease Activity Index (CDAI)</p><br>		
		</div>
			<div class="tableSearch clrfix">
				<section>
				
				
				 <form:form commandName="patient" action="cdai_search.it" method="GET">
...
<table class ="tablecontent3">	
						<tr>
							...
							<th class="phn">CDAI Score</th>
							<th class="ind">Score Interpretation</th>
						</tr>
		...
		<tr>
			...
			<c:forEach items="${cdaiForms }" var="form">
			<tr>
				<td><div class="blue"></div></td>
				<td class="pro"><a href="cdai_view.it?pid=${patient.getId()}&fid=${form.getId()}">${ form.getRevisionHistory().getDateCreated()}</a></td>
				
				<td class="phn">${form.CDAIScore }</td>
				<td class="ind">${form.CDAIScoreInterpretation }</td>
			</tr>
			</c:forEach>
		</table>
