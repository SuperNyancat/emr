...
<html lang="en">
<head>
	<title>Create Damage Index for SLE</title>
	<meta charset="utf-8">
</head>
...
<div class="content-wrap">
	<div class="wrapper prospects">
		...
		<div class="tab-content">
			...
			<div class="right">
			<form:form action="create_damage_index_form.it?id=${patient.getId() }" method="post" commandName="form">
				<div>
...
<li>
		...
		<table class="tablecontent2">
			...
			<tr>
				...
				<td class="phn"><form:radiobutton path="cardiovascular2" required="true" value="0"/>0 <form:radiobutton path="cardiovascular2" required="true" value="1" />1 <form:radiobutton path="cardiovascular2" required="true" value="2"/>2</td>
			</tr>
			...
			<section>
				<ul class="btnForm">
					...
					<a href="damage_index_SLE_table.it?id=${patient.getId() }"><span class="btn"><input type="button"
