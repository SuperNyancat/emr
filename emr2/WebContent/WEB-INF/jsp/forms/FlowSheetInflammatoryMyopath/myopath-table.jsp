...
<html lang="en">
<head>
	<title>Inflammatory Myopathy Records</title>
	<meta charset="utf-8">
...
<c:choose>
	...
	<ul class="ctrlBtn">
		<li><span class="btn"><a href="inflammatory_myopath_form_assembler.it?id=${patient.getId() }"><input type="button" value="New Record" class="btnNew"></a></span></li>
...
<div class="content-wrap">	
	<div class="wrapper prospects">
		...
		<div style="background:goldenrod">
				<br><p class="titles" style="color:white;">Inflammatory Myopathy Flow Sheet</p><br>		
		</div>
			<div class="tableSearch clrfix">
				<section>
					    <form:form commandName="patient" action="search_inflammatory_myopath.it" method="GET">
				...
				<table class="tablecontent3">
						...
						<tr>
							...
							<th class="phn">Clinical Data</th>
							<th class="ind">Meds/Plans</th>
		...
		<tr>
			...
			<c:forEach items="${myopathForms }" var="form">
				<tr>
				<td><div class="blue"></div></td>
				<td class="pro"><a href="view_inflammatory_myopath.it?pid=${patient.getId()}&fid=${form.getId()}">${ form.getRevisionHistory().getDateCreated()}</th>
				
				<td class="phn">${form.getClinicalData() }</td>				
				<td class="ind">${form.getPlans() }</td>		
