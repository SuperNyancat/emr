...
<div class="right">
				<p class="titles">Bath Ankylosing Spondylitis Metrology Index</p><br>	
				 <br><br>
					...
					<tr>
					<td>Score:
					<td><form:checkbox path="score" value="0" style="margin-left:15px;" />0					
					<td><form:checkbox path="score" value="1" style="margin-left:15px;" />1
					<td><form:checkbox path="score" value="2" style="margin-left:15px;" />2
					<td><form:checkbox path="score" value="3" style="margin-left:15px;" />3
					<td><form:checkbox path="score" value="4" style="margin-left:15px;" />4
					<td><form:checkbox path="score" value="5" style="margin-left:15px;" />5
					<td><form:checkbox path="score" value="6" style="margin-left:15px;" />6
					<td><form:checkbox path="score" value="7" style="margin-left:15px;" />7
					<td><form:checkbox path="score" value="8" style="margin-left:15px;" />8
					<td><form:checkbox path="score" value="9" style="margin-left:15px;" />9
					<td><form:checkbox path="score" value="10" style="margin-left:15px;" />10
