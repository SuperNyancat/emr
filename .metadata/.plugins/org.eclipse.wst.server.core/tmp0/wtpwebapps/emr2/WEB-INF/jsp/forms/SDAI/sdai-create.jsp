...
<div class="content-wrap">
	<div class="wrapper prospects">
		...
		<div class="tab-content">
			...
			<div class="right">	
				<form:form action="sdai_create.it?id=${patient.id }" method="post" commandName="form">
							<div>
								<br><p class="titles" style="color:goldenrod">Simple Disease Activity Index (SDAI)</p><br>		
							</div>
							<br><br>
									...
									<img src="resources/images/human.png" height="510px">
									</div>									
									<table border="1px" class="navigation" style="margin:0px auto;">
									<tr>
										<td colspan="7">
			...
			<section>
				<ul class="btnForm">
					...
					<a href="sdai_table.it?id=${patient.getId() }"><span class="btn"><input type="button"
