...
<div class="content-wrap">
    ...
    <div class="div-left">
        ...
        <form:input type="text" path="genericName" class="form-control" placeholder="Generic Name" required="true"/>
        <br><br>
        <label for="text" class="sr-only">Uses</label>
        <form:textarea  rows="4" cols="50" type="text" path="uses"  class="form-control" placeholder="Uses" required="true"/>
    ...
    <div class="div-right_med">
        ...
        <form:input type="text" path="brandName" class="form-control" placeholder="Brand Name" required="true"/>
        <br><br>
        <label for="text" class="sr-only">Side Effects</label>
        <form:textarea  rows="4" cols="50" type="text" path="sideEffects" class="form-control" placeholder="Side Effects" required="true"/>
        <br>
        </div>
    </div>
    <div class="div_button_med">
          <table>
            <tr>
            <td class="col-md-8" align="center"><input type="submit" value = "Create Medicine"class="btn btn-default-create"/></td>
