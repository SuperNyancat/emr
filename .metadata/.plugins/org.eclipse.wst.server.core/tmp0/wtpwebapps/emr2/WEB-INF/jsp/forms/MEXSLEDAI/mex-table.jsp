...
<html lang="en">
<head>
	<title>MEX SLEDAI Records</title>
	<meta charset="utf-8">
...
<c:choose>
	...
	<ul class="ctrlBtn">
		<li><span class="btn"><a href="MEXSLEDAI_form_assembler.it?id=${patient.getId() }"><input type="button" value="New Record" class="btnNew"></a></span></li>
...
<div class="content-wrap">	
	<div class="wrapper prospects">
		...
		<div style="background:goldenrod">
				<br><p class="titles" style="color:white;">MEX SLEDAI</p><br>		
		</div>
			<div class="tableSearch clrfix">
				<section>
					    <form:form commandName="patient" action="search_mex_sledai.it" method="GET">
		...
		<tr>
			...
			<tr>
				...
				<td class="pro"><a href="view_MEXSLEDAI.it?pid=${patient.getId()}&fid=${form.getId()}">${ form.getRevisionHistory().getDateCreated()}</a></td>
