...
<div class="pageCtrl">
 <c:choose>
	...
	<ul class="ctrlBtn">
		<li><a href="create_doctor_assembler.it"><span class="btn"><input type="button" value="New Doctor" class="btnNew"></span></a></li>
...
<div class="content-wrap">
	...
	<div class="wrapper prospects">
			...
			<section>
			   <form method="post" action="search_doctor.it" >
				<ul class="pro">
					<li><label>Name</label>:<input type="text" name="name"></li>

				</ul>
				<ul class="phn">
					<li><label>Specialization</label>:<input type="text" name="specialization"></li>
				</ul>
		...
		<table class="tablecontent3">
				...
				<tr>
					...
					<th class="phn"><a href="">Specialization<span class="greenArrow">&nbsp;</span></a></td>
		...
		<tr>
			...
			<tr>
				...
				<td class="pro"><a href="view_doctor_profile.it?id=${doc.getId() }" title="">${doc.getPersonInfo().getFirstName()} ${doc.getPersonInfo().getLastName()}</a></td>
				<td class="phn">${doc.getSpecialization() }</td>
				<td class="ind">${doc.getPersonInfo().getEmail() }</td>
				<td class="web">${doc.getPersonInfo().getContacts().get(0).getMobileNumber()}</td>			
			</tr>
			</c:forEach>
		</table>
