...
<div class="pageCtrl">
	<ul class="ctrlBtn">
		<li><span class="btn"><a href="create_medications_and_prescriptions_assembler.it?id=${patient.getId() }"><input type="button" value="New Record" class="btnNew"></span></a></li>
	...
	<div class="wrapper prospects">
		...
		<div class="tab-content">
			<div class="tableSearch clrfix">
				<section>
					    <form:form commandName="patient" action="search_medications.it" method="GET">
						<form:hidden path="id" value="${patient.id }" />	<ul class="pro">
					...
					<table class="tablecontent3">		
						<tr>
							...
							<th class="phn"><a href="">Brand Name</a></td>
							<!-- <td class="ind"><a href="">Dosage</a></td>-->
						</tr>
		...
		<tr>
			...
			<c:forEach items="${medsForms }" var="form">
			<tr>
				<td><div class="blue"></div></td>
				<td class="pro"><a href="view_pres_meds.it?pid=${patient.getId()}&fid=${form.getId()}">${ form.getRevisionHistory().getDateCreated()}</a></td>
				<td class="phn">
				<c:forEach items="${form.getMedications() }" var="meds">
					${meds.getBrandName() }, 
				</c:forEach>
				</td>
