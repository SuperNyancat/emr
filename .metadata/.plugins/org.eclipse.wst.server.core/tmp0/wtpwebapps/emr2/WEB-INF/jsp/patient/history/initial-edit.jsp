		...
		<div class="tabs">
			...
			<div class="tab-content">
				...
				<div class="rightHistory">
						<form:form method="post" class="crmForm" commandName="form" action="ih_update.it?pid=${patient.id }&fid=${form.id }" >
...
<td><form:input style="width:300px;" path="generalInfo.referredBy" value="${form.getGeneralInfo().getReferredBy()}" /></td>
</tr>
<tr>
<td>The name of the physician your primary medical care: </td>
<td> <form:input style="width:300px;" path="generalInfo.physicianName" value="${form.getGeneralInfo().getPhysicianName()}" /></td>
</tr>
<tr>
...
<td> <form:textarea style="width:350px;height:50px;" path="generalInfo.symptoms" value="${form.getGeneralInfo().getSymptoms()}"/></td>
</tr>
<tr>
<td>Date symptoms began (approximate):</td>
<td><input style="width:120px;" name="dateOfSymptoms" type="text" id="inputField" value="${form.getGeneralInfo().getDateOfSymptoms()}" /></td>
</tr>
<tr><td>Diagnosis:</td> <td><form:input style="width:300px;" path="generalInfo.diagnosis" value="${form.getGeneralInfo().getDiagnosis()}" /></td>
</tr>
<tr><td>Previous treatment for this problem(include physical therapy, surgery and injections; medications to be listed later)</td> <td><form:textarea style="width:350px; height:50px;" path="generalInfo.previousTreatment" value="${form.getGeneralInfo().getPreviousTreatment()}" />
</tr>
<tr><td>Please list the names of other practitioners you have seen for this problem:</td> <td><form:textarea style="width:350px; height:50px;" path="generalInfo.otherPractitioners" value="${form.getGeneralInfo().getOtherPractitioners()}" /> </td>
</tr>
</table>
						...
						<br><br><br>
							<br><h1>Rheumatologic (Arthritis) History</h1>
								...
								<td rowspan=2><form:checkbox path="rheumaHistory.arthritis" value="Yourself;"/>Yourself</td>
									...
									<td><label>Name</label>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input path="rheumaHistory.arthritis_name"  value="${form.getRheumaHistory().getArthritis_name()}" style="width:120px"/></td>
								</tr>

								<tr>
									<td><label>Relationship</label>  <form:input path="rheumaHistory.arthritis_relationship" value="${form.getRheumaHistory().getArthritis_relationship()}" style="width:120px"/></td> 
								</tr>	
								...
								<td rowspan=2><form:checkbox path="rheumaHistory.osteoArthritis" value="Yourself;"/>Yourself</td>
									...
									<td><label>Name</label>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input path="rheumaHistory.osteoArthritis_name" value="${form.getRheumaHistory().getOsteoArthritis_name()}" style="width:120px"/></td>
								</tr>

								<tr>
									<td><label>Relationship</label>  <form:input path="rheumaHistory.osteoArthritis_relationship" value="${form.getRheumaHistory().getOsteoArthritis_relationship()}" style="width:120px"/></td> 
								</tr>
								...
								<td rowspan=2><form:checkbox path="rheumaHistory.gout" value="Yourself;"/>Yourself</td>
									...
									<td><label>Name</label>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input path="rheumaHistory.gout_name" value="${form.getRheumaHistory().getGout_name()}" style="width:120px"/></td>
								</tr>

								<tr>
									<td><label>Relationship</label>  <form:input path="rheumaHistory.gout_relationship" value="${form.getRheumaHistory().getGout_relationship()}" style="width:120px"/></td> 
								</tr>	
								...
								<td rowspan=2><form:checkbox path="rheumaHistory.childhoodArthritis" value="Yourself;"/>Yourself</td>
									...
									<td><label>Name</label>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input path="rheumaHistory.childhoodArthritis_name" value="${form.getRheumaHistory().getChildhoodArthritis_name()}" style="width:120px"/></td>
								</tr>

								<tr>
									<td><label>Relationship</label>  <form:input path="rheumaHistory.childhoodArthritis_relationship" value="${form.getRheumaHistory().getChildhoodArthritis_relationship()}" style="width:120px"/></td> 
								</tr>
								...
								<td rowspan=2><form:checkbox path="rheumaHistory.lupus" value="Yourself;"/>Yourself</td>
									...
									<td><label>Name</label>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input path="rheumaHistory.lupus_name" value="${form.getRheumaHistory().getLupus_name()}" style="width:120px"/></td>
								</tr>

								<tr>
									<td><label>Relationship</label>  <form:input path="rheumaHistory.lupus_relationship" value="${form.getRheumaHistory().getLupus_relationship()}" style="width:120px"/></td> 
								</tr>
								...
								<td rowspan=2><form:checkbox path="rheumaHistory.rheumatoid" value="Yourself;"/>Yourself</td>
									...
									<td><label>Name</label>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input path="rheumaHistory.rheumatoid_name" value="${form.getRheumaHistory().getRheumatoid_name()}" style="width:120px"/></td>
								</tr>

								<tr>
									<td><label>Relationship</label>  <form:input path="rheumaHistory.rheumatoid_relationship" value="${form.getRheumaHistory().getRheumatoid_relationship()}" style="width:120px"/></td> 
								</tr>	
								...
								<td rowspan=2><form:checkbox path="rheumaHistory.ankylosing" value="Yourself;"/>Yourself</td>
									...
									<td><label>Name</label>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input path="rheumaHistory.ankylosing_name" value="${form.getRheumaHistory().getAnkylosing_name()}" style="width:120px"/></td>
								</tr>

								<tr>
									<td><label>Relationship</label>  <form:input path="rheumaHistory.ankylosing_relationship" value="${form.getRheumaHistory().getAnkylosing_relationship()}" style="width:120px"/></td> 
								</tr>	
								...
								<td rowspan=2><form:checkbox path="rheumaHistory.osteo" value="Yourself;"/>Yourself</td>
									...
									<td><label>Name</label>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input path="rheumaHistory.osteo_name" value="${form.getRheumaHistory().getOsteo_name()}" style="width:120px"/></td>
								</tr>

								<tr>
									<td><label>Relationship</label>  <form:input path="rheumaHistory.osteo_relationship" value="${form.getRheumaHistory().getOsteo_relationship()}" style="width:120px"/></td> 
								</tr>	
								<tr>
									<td rowspan=2>Other Arthritis Conditions:</td>
									<td rowspan=3><form:input path="rheumaHistory.others" value="${form.getRheumaHistory().getOthers()}" /></td>
								</tr>
								</table>
...
<table>
<tr>        
<td>Date of last mammogram: <td><input style="width:120px;" name="mammogram" type="text" id="inputField" value="${form.systemsReview.mammogram}" readonly></td>  
<td>Date of last eye exam: <td><input style="width:120px;" name="eyeExam" type="text" id="inputField" value="${form.systemsReview.eyeExam}" readonly> </td>
<td>Date of last chest x-ray: <td><input style="width:120px;" name="chestXRay" type="text" id="inputField" value="${form.systemsReview.chestXRay}" readonly> </td>
</tr>
<tr>
<td>Date of last Tuberculosis Test: <td><input style="width:120px;" name="tuberculosis" type="text" id="inputField" value="${form.systemsReview.tuberculosis}" readonly/></td> 
<td>Date of last bone densitometry: <td><input style="width:120px;" name="boneDensitometry" type="text" id="inputField" value="${form.systemsReview.boneDensitometry}" readonly/></td></li><br>
</tr>
</table>

<li><b><u>Constitutional</b></u></li><br>
<li><form:checkbox path="systemsReview.constitutional" value="Weight Gain"/>Recent weight gain;   amount:(lbs) <form:input path="systemsReview.weightGain" value="${form.getSystemsReview().getWeightGain()}" style="width:30px;"/> <form:checkbox path="systemsReview.constitutional" value="Weight Loss"/>Recent weight loss;   amount:(lbs) <form:input path="systemsReview.weightLoss" value="${form.getSystemsReview().getWeightLoss()}" style="width:30px;" /> <form:checkbox path="systemsReview.constitutional" value="Fatigue"/>Fatigue <form:checkbox path="systemsReview.constitutional" value="Weakness"/>Weakness <form:checkbox path="systemsReview.constitutional" value="Fever"/>Fever </li><br>
...
<tr>
<td>Age when periods began: <form:input style="width:120px;" path="systemsReview.agePeriod" value="${form.getSystemsReview().getAgePeriod()}" /> <td> Periods regular? <form:radiobutton value="Yes" path="systemsReview.regular"/>Yes <form:radiobutton value="No" path="systemsReview.regular"/>No <td>How many days apart? <form:input style="width:120px;" path="systemsReview.daysApart" value="${form.getSystemsReview().getDaysApart()}" />
</tr>
<tr>
<td>Date of last period? <input style="width:120px;" name="lastPeriod" type="text" id="inputField" value="${form.systemsReview.lastPeriod}" readonly/> <td>Date of last pap?  <input style="width:120px;" name="lastPap" type="text" id="inputField" value="${form.systemsReview.lastPap}" readonly/>  <td>Bleeding after menopause? <form:radiobutton value="Yes" path="systemsReview.bleedingAfterMenopause"/>Yes <form:radiobutton value="No" path="systemsReview.bleedingAfterMenopause"/>No </li><br><br>
</tr>
<tr>
<td>Number of pregnancies? <form:input style="width:120px;" path="systemsReview.pregnancies" value="${form.getSystemsReview().getPregnancies()}" /> <td>Number of miscarriages? <form:input style="width:120px;" path="systemsReview.miscarriages" value="$form.getSystemsReview().getMiscarriages()}" /></li><br>
</tr>
</table>

<li><b><u>Muscoloskeletal</b></u></li><br>
<li><form:checkbox value="Morning stiffness" path="systemsReview.musculoskeletal"/>Morning stiffness --- Lasting how long? <form:input style="width:30px;" path="systemsReview.hours" value="${form.getSystemsReview().getHours()}" /> hours and <form:input style="width:30px;" path="systemsReview.min" value="${form.getSystemsReview().getMin()}" /> minutes &nbsp&nbsp&nbsp&nbsp  <form:checkbox value="Joint pain" path="systemsReview.musculoskeletal"/>Joint pain <form:checkbox value="Muscle weakness" path="systemsReview.musculoskeletal"/>Muscle weakness <form:checkbox value="Muscle tenderness" path="systemsReview.musculoskeletal"/>Muscle tenderness <form:checkbox value="Joint swelling" path="systemsReview.musculoskeletal"/>Joint swelling</li><br><br>
<li>List joints affected in the last 6 months: <form:textarea style="width:550px; height:50px;" path="systemsReview.joints" value="${form.getSystemsReview().getJoints()}" /></li><br><br>
							...
							<br><h1>Social History</h1>	
								...
								<tr>
									<td>
										...
										<form:input path="socialHistory.glassesPerDay" type="number" min="0" max="20" step="1" size="0" value="${form.getSocialHistory().getGlassesPerDay()}" />									
									</td>
								
									<td>
										<p>IF PAST, how long ago?</p>
										<form:input path="socialHistory.smokingDuration" value="${form.getSocialHistory().getSmokingDuration()}" />																										
									</td>
								...
								<tr>
									...
									<td>
										...
										<form:input path="socialHistory.numberPerWeek" type="number" min="0" max="90" step="1" size="0" value="${form.getSocialHistory().getNumberPerWeek()}" />Bottle/s									
									</td>
								...
								<tr>															
									...
									<td>
										...
										<form:textarea path="socialHistory.listOfDrugs" value="${form.getSocialHistory().getListOfDrugs()}" rows="4" cols="50"/>									
									</td>
								</tr>
								...
								<tr>
									...
									<label>Type</label><form:input path="socialHistory.exerciseType" style="width:200px" value="${form.getSocialHistory().getExerciseType()}" />	
									<br><label>Amount&nbspper&nbspWeek</label><form:input path="socialHistory.exerciseWeeklyAmount" style="width:200px" value="${form.getSocialHistory().getExerciseWeeklyAmount()}" />
									</td>
									
									<td align="center">
										<p>How many hours of sleep do you get at night?</p>
											<form:input path="socialHistory.hoursOfSleep" type="number" min="0" max="50" step="1" size="0" value="${form.getSocialHistory().getHoursOfSleep()}" />Hour/s<br><br>
...
<tr><td>Other significant illness (please list): <td><form:textarea style="width:700px;height:50px;" path="medicalHistory.others" value="${form.getMedicalHistory().getOthers()}" /></tr>
<tr><td>Natural or Alternative Therapies: <td><form:textarea style="width:700px;height:50px;" path="medicalHistory.therapies" value="${form.getMedicalHistory().getTherapies()}"/></tr>
</table>
</ul>
								</div>
			...
			<br><h1>Previous Operations</h1>		
				...
				<table border="1px" class="navigation">
					...
					<tr>
						<td align="center">1.  <form:input path="previousOperations.previousOperations[0].type" style="width:200px" value="${form.getPreviousOperations().previousOperations[0].getType()}" /></td>
						<td align="center"><form:input path="previousOperations.previousOperations[0].year" style="width:50px" value="${form.getPreviousOperations().previousOperations[0].getYear()}"/></td>
						<td align="center"><form:input path="previousOperations.previousOperations[0].reason" style="width:650px" value="${form.getPreviousOperations().previousOperations[0].getReason()}"/></td>
					</tr>

					<tr>
						<td align="center">2.  <form:input path="previousOperations.previousOperations[1].type" style="width:200px" value="${form.getPreviousOperations().previousOperations[1].getType()}"/></td>
						<td align="center"><form:input path="previousOperations.previousOperations[1].year" style="width:50px" value="${form.getPreviousOperations().previousOperations[1].getYear()}"/></td>
						<td align="center"><form:input path="previousOperations.previousOperations[1].reason" style="width:650px" value="${form.getPreviousOperations().previousOperations[1].getReason()}"/></td>
					</tr>

					<tr>
						<td align="center">3.  <form:input path="previousOperations.previousOperations[2].type" style="width:200px" value="${form.getPreviousOperations().previousOperations[2].getType()}"/></td>
						<td align="center"><form:input path="previousOperations.previousOperations[2].year" style="width:50px" value="${form.getPreviousOperations().previousOperations[2].getYear()}"/></td>
						<td align="center"><form:input path="previousOperations.previousOperations[2].reason" style="width:650px" value="${form.getPreviousOperations().previousOperations[2].getReason()}"/></td>
					</tr>

					<tr>
						<td align="center">4.  <form:input path="previousOperations.previousOperations[3].type" style="width:200px" value="${form.getPreviousOperations().previousOperations[3].getType()}"/></td>
						<td align="center"><form:input path="previousOperations.previousOperations[3].year" style="width:50px" value="${form.getPreviousOperations().previousOperations[3].getYear()}"/></td>
						<td align="center"><form:input path="previousOperations.previousOperations[3].reason" style="width:650px" value="${form.getPreviousOperations().previousOperations[3].getReason()}"/></td>
					</tr>

					<tr>
						<td align="center">5.  <form:input path="previousOperations.previousOperations[4].type" style="width:200px" value="${form.getPreviousOperations().previousOperations[4].getType()}"/></td>
						<td align="center"><form:input path="previousOperations.previousOperations[4].year" style="width:50px" value="${form.getPreviousOperations().previousOperations[4].getYear()}"/></td>
						<td align="center"><form:input path="previousOperations.previousOperations[4].reason" style="width:650px" value="${form.getPreviousOperations().previousOperations[4].getReason()}"/></td>
					</tr>

					<tr>
						<td align="center">6.  <form:input path="previousOperations.previousOperations[5].type" style="width:200px" value="${form.getPreviousOperations().previousOperations[5].getType()}"/></td>
						<td align="center"><form:input path="previousOperations.previousOperations[5].year" style="width:50px" value="${form.getPreviousOperations().previousOperations[5].getYear()}"/></td>
						<td align="center"><form:input path="previousOperations.previousOperations[5].reason" style="width:650px" value="${form.getPreviousOperations().previousOperations[5].getReason()}"/></td>
					</tr>

					<tr>
						<td align="center">7.  <form:input path="previousOperations.previousOperations[6].type" style="width:200px" value="${form.getPreviousOperations().previousOperations[6].getType()}"/></td>
						<td align="center"><form:input path="previousOperations.previousOperations[6].year" style="width:50px" value="${form.getPreviousOperations().previousOperations[6].getYear()}"/></td>
						<td align="center"><form:input path="previousOperations.previousOperations[6].reason" style="width:650px" value="${form.getPreviousOperations().previousOperations[6].getReason()}"/></td>
					</tr>									
				</table>	
				<br><br>
				<table>
					<tr>
						...
						<td>
							<p>Describe:</p>
							<form:textarea path="previousOperations.fracturesDescriptions" value="${form.getPreviousOperations().getFracturesDescriptions()}" rows="4" cols="50"/> 										
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<p>Describe:</p>
							<form:textarea path="previousOperations.injuriesDescriptions" value="${form.getPreviousOperations().getInjuriesDescriptions()}" rows="4" cols="50"/>										
						</td>
					</tr>
...
<tr>
<td>If living - <td><form:input style="width:50px;" path="familyHistory.f_age" value="${form.getFamilyHistory().getF_age()}" /> <td> <form:input style="width:220px;" path="familyHistory.f_health" value="${form.getFamilyHistory().getF_health()}" /> <td>If deceased - <td> <form:input style="width:50px;" path="familyHistory.f_ageDeath" value="${form.getFamilyHistory().getF_ageDeath()}" /> <td><form:input style="width:220px;" path="familyHistory.f_cause" value="${form.getFamilyHistory().getF_cause()}" /></tr>
<tr><th style="width:50px;" colspan="6">Mother</th></tr>
<tr>
<td>If living - <td><form:input style="width:50px;" path="familyHistory.m_age" value="${form.getFamilyHistory().getM_age()}" /> <td> <form:input style="width:220px;" path="familyHistory.m_health" value="${form.getFamilyHistory().getM_health()}" /> <td>If deceased - <td> <form:input style="width:50px;" path="familyHistory.m_ageDeath" value="${form.getFamilyHistory().getM_ageDeath()}" /> <td><form:input style="width:220px;" path="familyHistory.m_cause" value="${form.getFamilyHistory().getM_cause()}"/></tr>
</table></li>
<li><br><br>

<table>
<td>Number of siblings: <form:input style="width:120px;" path="familyHistory.siblings" value="${form.getFamilyHistory().getSiblings()}"/> <td>Number living: <form:input style="width:120px;" path="familyHistory.s_living" value="${form.getFamilyHistory().getS_living()}" /> <td>Number deceased: <form:input style="width:120px;" path="familyHistory.s_deceased" value="${form.getFamilyHistory().getS_deceased()}" /></tr>
</tr>
<tr>
<td>Number of children: <form:input style="width:120px;" path="familyHistory.childrenNum" value="${form.getFamilyHistory().getChildrenNum()}" /> <td>Number living: <form:input style="width:120px;" path="familyHistory.c_living" value="${form.getFamilyHistory().getC_living()}" /> <td>Number deceased: <form:input style="width:120px;" path="familyHistory.c_deceased" value="${form.getFamilyHistory().getC_deceased()}" /> </tr>
<tr><td>List ages of each <form:input style="width:200px;" path="familyHistory.ages"/></tr>
</table>
<li>Health of children: <form:textarea style="width:700px;height:50px;" path="familyHistory.healthOfChildren" value="${form.getFamilyHistory().getHealthOfChildren()}" /> </li><br>
<li>Do you know of any blood relative who has or had: (check and give relationship)</li><br>
<table>

<tr><td><form:checkbox value="Cancer" path="familyHistory.bloodRelativesDiseases"/>Cancer<form:input style="width:120px;" path="familyHistory.cancer" value="${form.getFamilyHistory().getCancer()}" /> <td><form:checkbox value="Heart disease" path="familyHistory.bloodRelativesDiseases"/>Heart disease<form:input style="width:120px;" path="familyHistory.heartDisease" value="${form.getFamilyHistory().getHeartDisease()}" /> <td><form:checkbox value="Rheumatic fever" path="familyHistory.bloodRelativesDiseases"/>Rheumatic fever<form:input style="width:120px;" path="familyHistory.rheumaticFever" value="${form.getFamilyHistory().getRheumaticFever()}" /> <td><form:checkbox value="Tuberculosis" path="familyHistory.bloodRelativesDiseases"/>Tuberculosis<form:input style="width:120px;" path="familyHistory.tubercolosis" value="${form.getFamilyHistory().getTubercolosis()}" /></tr>
<tr><td><form:checkbox value="Leukemia" path="familyHistory.bloodRelativesDiseases"/>Leukemia<form:input style="width:120px;" path="familyHistory.leukemia" value="${form.getFamilyHistory().getLeukemia()}" /><td><form:checkbox value="High Blood Pressure" path="familyHistory.bloodRelativesDiseases"/>High BP<form:input style="width:120px;" path="familyHistory.highBloodPressure" value="${form.getFamilyHistory().getHighBloodPressure()}" /><td><form:checkbox value="Epilepsy" path="familyHistory.bloodRelativesDiseases"/>Epilepsy<form:input style="width:120px;" path="familyHistory.epilepsy" value="${form.getFamilyHistory().getEpilepsy()}" /><td><form:checkbox value="Diabetes" path="familyHistory.bloodRelativesDiseases"/>Diabetes<form:input style="width:120px;" path="familyHistory.diabetes" value="${form.getFamilyHistory().getDiabetes()}" /></tr>
<tr><td><form:checkbox value="Stroke" path="familyHistory.bloodRelativesDiseases"/>Stroke<form:input style="width:120px;" path="familyHistory.stroke" value="${form.getFamilyHistory().getStroke()}" /><td><form:checkbox value="Bleeding" path="familyHistory.bloodRelativesDiseases"/>Bleeding<form:input style="width:120px;" path="familyHistory.bleedingTendency" value="${form.getFamilyHistory().getBleedingTendency()}" /><td><form:checkbox value="Asthma" path="familyHistory.bloodRelativesDiseases"/>Asthma<form:input style="width:120px;" path="familyHistory.asthma" value="${form.getFamilyHistory().getAsthma()}" /><td><form:checkbox value="Goiter" path="familyHistory.bloodRelativesDiseases"/>Goiter<form:input style="width:120px;" path="familyHistory.goiter" value="${form.getFamilyHistory().getGoiter()}" /></tr>
<tr><td><form:checkbox value="Colitis" path="familyHistory.bloodRelativesDiseases"/>Colitis<form:input style="width:120px;" path="familyHistory.colitis" value="${form.getFamilyHistory().getColitis()}" /><td><form:checkbox value="Alcoholism" path="familyHistory.bloodRelativesDiseases"/>Alcoholism<form:input style="width:120px;" path="familyHistory.alcoholism" value="${form.getFamilyHistory().getAlcoholism()}" /><td><form:checkbox value="Psoriasis" path="familyHistory.bloodRelativesDiseases"/>Psoriasis<form:input style="width:120px;" path="familyHistory.psoriasis" value="${form.getFamilyHistory().getPsoriasis()}" /></tr>
</table><br><br>
</ul>
								</div>
							...
							<br><h1>Medications</h1>		
								...
								<p>To what?</p>
								<form:textarea path="presentMedications.drugAllergyDetails" value="${form.getPresentMedications().getDrugAllergyDetails()}" rows="4" cols="50"/><br><br>
								<p>Type of reaction:</p>
								<form:textarea path="presentMedications.reaction" value="${form.getPresentMedications().getReaction()}" rows="4" cols="50"/><br><br>
								...
								<table border="1" class="navigation" style="margin:0px auto;">
									...
									<tr>
										<td align="center">1.<form:input path="presentMedications.presentMedications[0].name" style="width:200px" value="${form.getPresentMedications().presentMedications[0].getName()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[0].dose" style="width:50px" value="${form.getPresentMedications().presentMedications[0].getDose()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[0].duration" style="width:100px" value="${form.getPresentMedications().presentMedications[0].getDuration()}" /></td>
									...
									<tr>
										<td align="center">2.<form:input path="presentMedications.presentMedications[1].name" style="width:200px" value="${form.getPresentMedications().presentMedications[1].getName()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[1].dose" style="width:50px" value="${form.getPresentMedications().presentMedications[1].getDose()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[1].duration" style="width:100px" value="${form.getPresentMedications().presentMedications[1].getDuration()}" /></td>
									...
									<tr>
										<td align="center">3.<form:input path="presentMedications.presentMedications[2].name" style="width:200px" value="${form.getPresentMedications().presentMedications[2].getName()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[2].dose" style="width:50px" value="${form.getPresentMedications().presentMedications[2].getDose()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[2].duration" style="width:100px" value="${form.getPresentMedications().presentMedications[2].getDuration()}" /></td>
									...
									<tr>
										<td align="center">4.<form:input path="presentMedications.presentMedications[3].name" style="width:200px" value="${form.getPresentMedications().presentMedications[3].getName()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[3].dose" style="width:50px" value="${form.getPresentMedications().presentMedications[3].getDose()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[3].duration" style="width:100px" value="${form.getPresentMedications().presentMedications[3].getDuration()}" /></td>
									...
									<tr>
										<td align="center">5.<form:input path="presentMedications.presentMedications[4].name" style="width:200px" value="${form.getPresentMedications().presentMedications[4].getName()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[4].dose" style="width:50px" value="${form.getPresentMedications().presentMedications[4].getDose()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[4].duration" style="width:100px" value="${form.getPresentMedications().presentMedications[4].getDuration()}" /></td>
									...
									<tr>
										<td align="center">6.<form:input path="presentMedications.presentMedications[5].name" style="width:200px" value="${form.getPresentMedications().presentMedications[5].getName()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[5].dose" style="width:50px" value="${form.getPresentMedications().presentMedications[5].getDose()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[5].duration" style="width:100px" value="${form.getPresentMedications().presentMedications[5].getDuration()}" /></td>
									...
									<tr>
										<td align="center">7.<form:input path="presentMedications.presentMedications[6].name" style="width:200px" value="${form.getPresentMedications().presentMedications[6].getName()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[6].dose" style="width:50px" value="${form.getPresentMedications().presentMedications[6].getDose()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[6].duration" style="width:100px" value="${form.getPresentMedications().presentMedications[6].getDuration()}" /></td>
									...
									<tr>
										<td align="center">8.<form:input path="presentMedications.presentMedications[7].name" style="width:200px" value="${form.getPresentMedications().presentMedications[7].getName()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[7].dose" style="width:50px" value="${form.getPresentMedications().presentMedications[7].getDose()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[7].duration" style="width:100px" value="${form.getPresentMedications().presentMedications[7].getDuration()}" /></td>
									...
									<tr>
										<td align="center">9.<form:input path="presentMedications.presentMedications[8].name" style="width:200px" value="${form.getPresentMedications().presentMedications[8].getName()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[8].dose" style="width:50px" value="${form.getPresentMedications().presentMedications[8].getDose()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[8].duration" style="width:100px" value="${form.getPresentMedications().presentMedications[8].getDuration()}" /></td>
									...
									<tr>
										<td align="center">10.<form:input path="presentMedications.presentMedications[9].name" style="width:200px" value="${form.getPresentMedications().presentMedications[9].getName()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[9].dose" style="width:50px" value="${form.getPresentMedications().presentMedications[9].getDose()}" /></td>
										<td align="center"><form:input path="presentMedications.presentMedications[9].duration" style="width:100px" value="${form.getPresentMedications().presentMedications[9].getDuration()}" /></td>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[0].length" value="${form.getPastMedications().pastMedications[0].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[0].reactions" value="${form.getPastMedications().pastMedications[0].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[1].length" value="${form.getPastMedications().pastMedications[1].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[1].reactions" value="${form.getPastMedications().pastMedications[1].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[2].length" value="${form.getPastMedications().pastMedications[2].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[2].reactions" value="${form.getPastMedications().pastMedications[2].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[3].length" value="${form.getPastMedications().pastMedications[3].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[3].reactions" value="${form.getPastMedications().pastMedications[3].getReactions()}" /></td>
</tr>

<tr>
<td>Other: <form:input path="pastMedications.pastMedications[4].drug" /></td>
<td><form:input style="width:120px" path="pastMedications.pastMedications[4].length" value="${form.getPastMedications().pastMedications[4].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[4].reactions" value="${form.getPastMedications().pastMedications[4].getReactions()}" /></td>
</tr>
<tr>
<td>Other:  <form:input path="pastMedications.pastMedications[5].drug" /></td>
<td><form:input style="width:120px" path="pastMedications.pastMedications[5].length" value="${form.getPastMedications().pastMedications[5].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[5].reactions" value="${form.getPastMedications().pastMedications[5].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[6].length" value="${form.getPastMedications().pastMedications[6].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[6].reactions" value="${form.getPastMedications().pastMedications[6].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[7].length" value="${form.getPastMedications().pastMedications[7].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[7].reactions" value="${form.getPastMedications().pastMedications[7].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[8].length" value="${form.getPastMedications().pastMedications[8].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[8].reactions" value="${form.getPastMedications().pastMedications[8].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[9].length" value="${form.getPastMedications().pastMedications[9].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[9].reactions" value="${form.getPastMedications().pastMedications[9].getReactions()}" /></td>
</tr>

<tr>
<td>Methotrexate (Rheumatrex)</td><form:hidden path="pastMedications.pastMedications[10].drug" value="Methotrexate (Rheumatrex)"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[10].length" value="${form.getPastMedications().pastMedications[10].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[10].reactions" value="${form.getPastMedications().pastMedications[10].getReactions()}" /></td>
</tr>

<tr>
<td>Azathioprine (Imuran)</td><form:hidden path="pastMedications.pastMedications[11].drug" value="Azathioprine (Imuran)"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[11].length" value="${form.getPastMedications().pastMedications[11].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[11].reactions" value="${form.getPastMedications().pastMedications[11].getReactions()}" /></td>
</tr>

<tr>
<td>Sulfasalazine (Azulfidine)</td><form:hidden path="pastMedications.pastMedications[12].drug" value="Sulfasalazine (Azulfidine)"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[12].length" value="${form.getPastMedications().pastMedications[12].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[12].reactions" value="${form.getPastMedications().pastMedications[12].getReactions()}" /></td>
</tr>

<tr>
<td>Quinacrine (Atabrine)</td><form:hidden path="pastMedications.pastMedications[13].drug" value="Quinacrine (Atabrine)"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[13].length" value="${form.getPastMedications().pastMedications[13].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[13].reactions" value="${form.getPastMedications().pastMedications[13].getReactions()}" /></td>
</tr>

<tr>
<td>Cyclophosphamide (Cytoxan)</td><form:hidden path="pastMedications.pastMedications[14].drug" value="Cyclophosphamide (Cytoxan)"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[14].length" value="${form.getPastMedications().pastMedications[14].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[14].reactions" value="${form.getPastMedications().pastMedications[14].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[15].length" value="${form.getPastMedications().pastMedications[15].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[15].reactions" value="${form.getPastMedications().pastMedications[15].getReactions()}" /></td>
</tr>

<tr>
<td>Etanercept (Enbrel)</td><form:hidden path="pastMedications.pastMedications[16].drug" value="Etanercept (Enbrel)"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[16].length" value="${form.getPastMedications().pastMedications[16].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[16].reactions" value="${form.getPastMedications().pastMedications[16].getReactions()}" /></td>
</tr>

<tr>
<td>Infliximab (Remicade)</td><form:hidden path="pastMedications.pastMedications[17].drug" value="Infliximab (Remicade)"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[17].length" value="${form.getPastMedications().pastMedications[17].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[17].reactions" value="${form.getPastMedications().pastMedications[17].getReactions()}" /></td>
</tr>

<tr>
<td>Prosorba Column</td><form:hidden path="pastMedications.pastMedications[18].drug" value="Prosorba Column"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[18].length" value="${form.getPastMedications().pastMedications[18].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[18].reactions" value="${form.getPastMedications().pastMedications[18].getReactions()}" /></td>
</tr>

<tr>
<td>Other: <form:input path="pastMedications.pastMedications[19].drug" /></td>
<td><form:input style="width:120px" path="pastMedications.pastMedications[19].length" value="${form.getPastMedications().pastMedications[19].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[19].reactions" value="${form.getPastMedications().pastMedications[19].getReactions()}" /></td>
</tr>

<tr>
<td>Other: <form:input path="pastMedications.pastMedications[20].drug" /></td>
<td><form:input style="width:120px" path="pastMedications.pastMedications[20].length" value="${form.getPastMedications().pastMedications[20].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[20].reactions" value="${form.getPastMedications().pastMedications[20].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[21].length" value="${form.getPastMedications().pastMedications[21].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[21].reactions" value="${form.getPastMedications().pastMedications[21].getReactions()}" /></td>
</tr>

<tr>
<td>Alendronate (Fosamax)</td><form:hidden path="pastMedications.pastMedications[22].drug" value="Alendronate (Fosamax)"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[22].length" value="${form.getPastMedications().pastMedications[22].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[22].reactions" value="${form.getPastMedications().pastMedications[22].getReactions()}" /></td>
</tr>

<tr>
<td>Etidronate (Didronel)</td><form:hidden path="pastMedications.pastMedications[23].drug" value="Etidronate (Didronel)"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[23].length" value="${form.getPastMedications().pastMedications[23].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[23].reactions" value="${form.getPastMedications().pastMedications[23].getReactions()}" /></td>
</tr>

<tr>
<td>Raloxifene (Evista)</td><form:hidden path="pastMedications.pastMedications[24].drug" value="Raloxifene (Evista)"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[24].length" value="${form.getPastMedications().pastMedications[24].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[24].reactions" value="${form.getPastMedications().pastMedications[24].getReactions()}" /></td>
</tr>

<tr>
<td>Flouride</td><form:hidden path="pastMedications.pastMedications[25].drug" value="Flouride"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[25].length" value="${form.getPastMedications().pastMedications[25].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[25].reactions" value="${form.getPastMedications().pastMedications[25].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[26].length" value="${form.getPastMedications().pastMedications[26].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[26].reactions" value="${form.getPastMedications().pastMedications[26].getReactions()}" /></td>
</tr>

<tr>
<td>Risedronte (Actonel)</td><form:hidden path="pastMedications.pastMedications[27].drug" value="Risedronte (Actonel)"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[27].length" value="${form.getPastMedications().pastMedications[27].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[27].reactions" value="${form.getPastMedications().pastMedications[27].getReactions()}" /></td>
</tr>

<tr>
<td>Other: <form:hidden path="pastMedications.pastMedications[28].drug"/></td>
<td><form:input style="width:120px" path="pastMedications.pastMedications[28].length" value="${form.getPastMedications().pastMedications[28].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[28].reactions" value="${form.getPastMedications().pastMedications[28].getReactions()}" /></td>
</tr>

<tr>
<td>Other: <form:hidden path="pastMedications.pastMedications[29].drug"/></td>
<td><form:input style="width:120px" path="pastMedications.pastMedications[29].length" value="${form.getPastMedications().pastMedications[29].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[29].reactions" value="${form.getPastMedications().pastMedications[29].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[30].length" value="${form.getPastMedications().pastMedications[30].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[30].reactions" value="${form.getPastMedications().pastMedications[30].getReactions()}" /></td>
</tr>

<tr>
<td>Colchicine</td><form:hidden path="pastMedications.pastMedications[31].drug" value="Colchicine"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[31].length" value="${form.getPastMedications().pastMedications[31].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[31].reactions" value="${form.getPastMedications().pastMedications[31].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[32].length" value="${form.getPastMedications().pastMedications[32].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[32].reactions" value="${form.getPastMedications().pastMedications[32].getReactions()}" /></td>
</tr>

<tr>
<td>Other: <form:input path="pastMedications.pastMedications[33].drug" /></td>
<td><form:input style="width:120px" path="pastMedications.pastMedications[33].length" value="${form.getPastMedications().pastMedications[33].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[33].reactions" value="${form.getPastMedications().pastMedications[33].getReactions()}" /></td>
</tr>

<tr>
<td>Other: <form:input path="pastMedications.pastMedications[34].drug" /></td>
<td><form:input style="width:120px" path="pastMedications.pastMedications[34].length" value="${form.getPastMedications().pastMedications[34].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[34].reactions" value="${form.getPastMedications().pastMedications[34].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[35].length" value="${form.getPastMedications().pastMedications[35].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[35].reactions" value="${form.getPastMedications().pastMedications[35].getReactions()}" /></td>
</tr>

<tr>
<td>Tiludronate(Skelid)</td><form:hidden path="pastMedications.pastMedications[36].drug" value="Tiludronate(Skelid)"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[36].length" value="${form.getPastMedications().pastMedications[36].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[36].reactions" value="${form.getPastMedications().pastMedications[36].getReactions()}" /></td>
</tr>

<tr>
<td>Cortisone/Predisone</td><form:hidden path="pastMedications.pastMedications[37].drug" value="Cortisone/Predisone"/>
<td><form:input style="width:120px" path="pastMedications.pastMedications[37].length" value="${form.getPastMedications().pastMedications[37].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[37].reactions" value="${form.getPastMedications().pastMedications[37].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[38].length" value="${form.getPastMedications().pastMedications[38].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[38].reactions" value="${form.getPastMedications().pastMedications[38].getReactions()}" /></td>
</tr>
...
<td><form:input style="width:120px" path="pastMedications.pastMedications[39].length" value="${form.getPastMedications().pastMedications[39].getLength()}" /></td>
...
<td><form:input style="width:200px" path="pastMedications.pastMedications[39].reactions" value="${form.getPastMedications().pastMedications[39].getReactions()}" /></td>
</tr>
...
<li><form:textarea style="height:50px;width:700px;" path="pastMedications.supplements" value="${form.getPastMedications().getSupplements()}" /></li><br>
...
<li>If yes, list: <form:textarea path="pastMedications.clinicalTrials_details" value="${form.getPastMedications().getClinicalTrials_details()}" style="height:50px;width:700px;"/></li><br>
</ul>
								</div>		
							...
							<br><h1>Activities of Daily Living</h1>		
								...
								&nbsp;&nbsp;&nbsp;IF YES, how many?<form:input path="activities.stairsCount" type="number" min="0" max="20" step="1" value="${form.getActivities().getStairsCount()}" size="0"/></p>
								<p>How many people in household?<form:input path="activities.houseHoldCount" type="number" min="0" max="20" step="1" value="${form.getActivities().getHouseHoldCount()}" size="-1"/></p>
								<p>Relationship and age of each:</p>
								<form:textarea path="activities.relationshipAge" value="${form.getActivities().getRelationshipAge()}" rows="4" cols="50"/><br><br>
								<p>Who does most of the housework?<form:input path="activities.houseWork" style="width:300px" value="${form.getActivities().getHouseWork()}" /></p>							
								<p>Who does most of the shopping?&nbsp&nbsp&nbsp <form:input path="activities.shopping" style="width:300px" value="${form.getActivities().getShopping()}" /></p>							
								<p>Who does most of the yard work?&nbsp&nbsp<form:input path="activities.yardWork" style="width:300px" value="${form.getActivities().getYardWork()}" /></p><br><br>
								...
								<form:textarea rows="4" path="activities.hardestThing" value="${form.getActivities().getHardestThing()}" cols="50"/><br><br>
