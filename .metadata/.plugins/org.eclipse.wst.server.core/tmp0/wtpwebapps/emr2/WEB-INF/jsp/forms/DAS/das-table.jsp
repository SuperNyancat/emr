...
<jsp:include page="../../headers/doctor-header.jsp">
	<jsp:param name="title" value="DAS28 Records" />
...
<c:choose>
	...
	<ul class="ctrlBtn">
		<li><span class="btn"><a href="das_assemble.it?id=${patient.getId() }"><input type="button" value="New Record" class="btnNew"></a></span></li>
...
<div class="content-wrap">	
	<div class="wrapper prospects">
		...
		<div style="background:goldenrod">
				<br><p class="titles" style="color:white;">Disease Activity Score in 28 Joints (DAS28)</p><br>		
		</div>
			<div class="tableSearch clrfix">
				<section>
				
				
				 <form:form commandName="patient" action="das_search.it" method="GET">
...
<table class ="tablecontent3">	
		...
		<tr>
			...
			<c:forEach items="${dasForms }" var="form">
			<tr>
				<td><div class="blue"></div></td>
				<td class="pro"><a href="das_view.it?pid=${patient.getId()}&fid=${form.getId()}">${ form.getRevisionHistory().getDateCreated()}</a></td>
				
				<td class="phn">${form.das28}</td>
				<td class="ind">${form.interpretation }</td>
			</tr>
			</c:forEach>
		</table>
