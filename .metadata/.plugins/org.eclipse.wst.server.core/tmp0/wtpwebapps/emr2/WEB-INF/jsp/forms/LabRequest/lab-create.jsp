...
<html lang="en">
<head>
	<title>Create Laboratory Request Form</title>
	<meta charset="utf-8">
		...
		<div class="tabs">
			...
			<div class="tab-content">
				...
				<jsp:include page="../../headers/patient-left.jsp" />
					...
					<div class="right">
						<form:form action="create_lab_request.it?id=${patient.getId() }" commandName="form" method="post">
							<p class="titles">LABORATORY REQUEST</p>
								...
								<ul>
									...
									<li>
										Bed Number: &nbsp&nbsp&nbsp&nbsp&nbsp <form:input pattern="\\d+(\\.\\d+)?" path="bedNumber"/>
										
									</li> <br/>
							
									<li>
										Admission Number:&nbsp&nbsp&nbsp&nbsp&nbsp <form:input  pattern="\\d+(\\.\\d+)?" path="admissionNumber"/>
										Hospital Number:&nbsp&nbsp&nbsp&nbsp&nbsp <form:input pattern="\\d+(\\.\\d+)?" path="hospitalNumber"/>
									</li><br>
									<li>
										Diagnosis:&nbsp&nbsp&nbsp&nbsp&nbsp <form:input path="diagnosis" required="true" />
										Specimen:&nbsp&nbsp&nbsp&nbsp&nbsp <form:input path="specimen" required="true" />	
									</li><br>
								</ul>
							...
							<label class="bigfont"><h4>OTHERS:</h4></label><br><br>
								<div>
									<form:textarea rows="4" cols="50" style="width:700px; height:100px;" path="othersTextArea"/>
								...
								<section>
									<ul class="btnForm">
										...
										<a href="lab_request_table.it?id=${patient.getId() }"><span class="btn"><input type="button"
