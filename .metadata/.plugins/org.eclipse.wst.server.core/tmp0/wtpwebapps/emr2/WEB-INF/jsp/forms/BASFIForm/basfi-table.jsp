...
<c:choose>
	...
	<ul class="ctrlBtn">
		<li><span class="btn"><a href="BASFI_form_assembler.it?id=${patient.getId() }"><input type="button" value="New Record" class="btnNew"></a></span></li>
...
<div class="content-wrap">	
	<div class="wrapper prospects">
		...
		<div style="background:goldenrod">
				<br><p class="titles" style="color:white;">Bath Ankylosing Spondylitis Functional Index (BASFI)</p><br>		
		</div>
			<div class="tableSearch clrfix">
				<section>
					  <form:form commandName="patient" action="search_basfi.it" method="GET">
				...
				<table class ="tablecontent3">	
						...
						<tr>
							...
							<th class="phn">Total</th>
							<th class="ind">BASFI Score</th>
						</tr>
		...
		<tr>
			...
			<tr>
				...
				<td class="pro"><a href="view_basfi.it?pid=${patient.getId()}&fid=${form.getId()}">${ form.getRevisionHistory().getDateCreated()}</a></td>
				
				<td class="phn">${form.getTotal() }</td>
				<td class="ind">${form.getBASFIScore() }</td>
				</tr>
			</c:forEach>
		</table>
