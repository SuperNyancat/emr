...
<c:choose>
	...
	<ul class="ctrlBtn">
		<li><span class="btn"><a href="damage_index_form_assembler.it?id=${patient.getId() }"><input type="button" value="New Record" class="btnNew"></a></span></li>
...
<div class="content-wrap">	
	<div class="wrapper prospects">
		...
		<div style="background:goldenrod">
				<br><p class="titles" style="color:white;">Damage Index for Systematic Lupus Erythematosus (SLE)</p><br>		
		</div>
			<div class="tableSearch clrfix">
				<section>
					   <form:form commandName="patient" action="search_damage_index_sle.it" method="GET">
...
<table class="tablecontent3">		
		...
		<tr>
			...
			<tr>
				...
				<td class="pro"><a href="view_damage_index.it?pid=${patient.getId()}&fid=${form.getId()}">${ form.getRevisionHistory().getDateCreated()}</a></td>
