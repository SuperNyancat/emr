...
<html lang="en">
<head>
	<title>Create Systematic Sclerosis Flow Sheet</title>
	<meta charset="utf-8">
...
<li>
<form:form action="create_SS_flowsheet.it?id=${patient.getId() }" method="post" commandName="form">
...
<table class="tablecontent2">
			...
			<tr>
				...
				<td class="phn"><form:input type="text" path="weight" pattern="\\d+(\\.\\d+)?" required="true" /></td>
			</tr>	
...
<tr><td class="pro1"><br><h4>Other Data</h4></td></tr>
...
<tr>
				<td class="pro">WBC</td>
				<td class="phn"><form:input type="text" path="WBC" /></td>
			</tr>	
<tr>
				<td class="pro">Platelet</td>
				<td class="phn"><form:input type="text" path="platelet" /></td>
			</tr>	
<tr>
				<td class="pro">ESR/CRP</td>
				<td class="phn"><form:input type="text" path="ESRorCRP" /></td>
			</tr>	
<tr>
...
<tr><td><br><h4>Rodnan skin scoring (0-normal, 1-weak, 2-intermediate, 3-severe)</h4></td></tr>
			...
			<tr>
				...
				<td class="phn">
					<form:input path="skinScore" pattern="\\d+(\\.\\d+)?" required="true"/>
				</td>
			</tr>	
...
<tr><td><br><h4>Self-Assessment</h4></td></tr>
			...
			<tr>
				...
				<td class="phn"><form:input path="cardiacOrPulmonary" /></td>
			</tr>	

			<tr>
				<td class="pro">Gastrointestinal</td>
				<td class="phn"><form:input path="gastrointestinal" /></td>
			</tr>	

			<tr>
				<td class="pro">Renal</td>
				<td class="phn"><form:input path="renal" /></td>
			</tr>	
...
<table class="tablecontent2">
			...
			<tr>
				...
				<td class="ind"><form:input type="text"  pattern="\\d+(\\.\\d+)?" path="weight" required="true" /></td>
			</tr>	
...
<tr>
				...
				<td class="ind"><form:input type="text" path="WBC" /></td>
			</tr>	
<tr>
				<td class="pro">Platelet</td>
				<td class="phn">${previous.get(0).getPlatelet() }</td>
				<td class="ind"><form:input type="text" path="platelet" /></td>
			</tr>	
<tr>
				<td class="pro">ESR/CRP</td>
				<td class="phn">${previous.get(0).getESRorCRP() }</td>
				<td class="ind"><form:input type="text" path="ESRorCRP" /></td>
			</tr>	
<tr>
				<td class="pro">ALT/AST</td>
...
<tr><td><br><h4>Self-Assessment</h4></td></tr>
			...
			<tr>
				...
				<td class="ind"><form:input path="cardiacOrPulmonary" /></td>
			</tr>	

			<tr>
				<td class="pro">Gastrointestinal</td>
				<td class="phn">${previous.get(0).getGastrointestinal()}</td>
				<td class="ind"><form:input path="gastrointestinal" /></td>
			</tr>	

			<tr>
				<td class="pro">Renal</td>
				<td class="phn">${previous.get(0).getRenal()}</td>
				<td class="ind"><form:input path="renal" /></td>
			</tr>	
...
<table class="tablecontent2">
			...
			<tr>
				...
				<td class="web"><form:input type="text" pattern="\\d+(\\.\\d+)?"  path="weight" required="true" /></td>
			</tr>	
...
<tr>
				...
				<td class="web"><form:input type="text" path="WBC" /></td>
			</tr>	
<tr>
				<td class="pro">Platelet</td>
				<td class="phn">${previous.get(0).getPlatelet() }</td>
				<td class="ind">${previous.get(1).getPlatelet() }</td>
				<td class="web"><form:input type="text" path="platelet" /></td>
			</tr>	
<tr>
				<td class="pro">ESR/CRP</td>
				<td class="phn">${previous.get(0).getESRorCRP() }</td>
				<td class="ind">${previous.get(1).getESRorCRP() }</td>
				<td class="web"><form:input type="text" path="ESRorCRP" /></td>
			</tr>	
<tr>
				<td class="pro">ALT/AST</td>
				<td class="phn">${previous.get(0).getALTorAST() }</td>
...
<tr><td><br><h4>Self-Assessment</h4></td></tr>
			...
			<tr>
				...
				<td class="web"><form:input path="cardiacOrPulmonary" /></td>
			</tr>	
			...
			<tr>
				...
				<td class="web"><form:input path="gastrointestinal" /></td>
			</tr>	
			...
			<tr>
				...
				<td class="web"><form:input path="renal" /></td>
			</tr>	
			...
			<tr>
				...
				<section>
					<ul class="btnForm">
						...
						<a href="SS_flowsheet_table.it?id=${patient.getId() }"><span class="btn"><input type="button"
