...
<html lang="en">
<head>
	<title>SLEDAI Score Records</title>
	<meta charset="utf-8">
</head>
...
<c:choose>
	...
	<ul class="ctrlBtn">
		<li><span class="btn"><a href="SLEDAI_score_form_assembler.it?id=${patient.getId() }"><input type="button" value="New Record" class="btnNew"></a></span></li>
...
<div class="content-wrap">	
	<div class="wrapper prospects">
		...
		<div style="background:goldenrod">
				<br><p class="titles" style="color:white;">Systematic Lupus Erythematosus Disease Activity Index (SLEDAI) Score</p><br>		
		</div>
			<div class="tableSearch clrfix">
				<section>
					   <form:form commandName="patient" action="search_sledai_score.it" method="GET">
		...
		<tr>
			...
			<tr>
				...
				<td class="pro"><a href="view_sledai_score.it?pid=${patient.getId()}&fid=${form.getId()}">${ form.getRevisionHistory().getDateCreated()}</a></td>
