...
<jsp:include page="../../headers/patient-left.jsp" />
			...
			<form:form action="update_sledai_score.it?pid=${patient.getId()}&fid=${form.getId()}" method="post" commandName="form" align="center">
			...
			<section>
				<ul class="btnForm">
					...
					<a href="view_sledai_score.it?pid=${patient.getId() }&fid=${form.id}"><span class="btn"><input type="button"
