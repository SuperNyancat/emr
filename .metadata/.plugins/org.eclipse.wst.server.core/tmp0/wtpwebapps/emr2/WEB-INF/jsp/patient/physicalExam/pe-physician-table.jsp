...
<div class="pageCtrl">
	<ul class="ctrlBtn">
		<li><span class="btn"><a href="ped_assemble.it?id=${patient.id }"><input type="button" value="New Record" class="btnNew"></a></span></li>
	</ul>
...
<div class="content-wrap">	
	<div class="wrapper prospects">
		...
		<div style="background:goldenrod">
				<br><p class="titles" style="color:white;">Physician's Assessment</p><br>		
		</div>
			<div class="tableSearch clrfix">
				<section>
					    <form:form commandName="patient" action="ped_search.it" method="GET">
					...
					<table class="tablecontent3">	
							...
							<tr>
								...
								<th class="phn">PGA Score</th>
								<th class="ind">Swollen Joints</th>	
								<th class="ind">Painful Joints</th>		
							</tr>
		...
		<tr>
			...
			<c:remove var="errorMessage" scope="session" /></td> 
				...
				<c:forEach items="${pedForms }" var="form">	
				<tr>
					<td><div class="blue"></div></td>
					<td class="pro"><a href="ped_view.it?pid=${form.patient.id}&fid=${form.id}">${ form.revisionHistory.dateCreated}</a></td>
					<td class="phn">${form.PGA}</td>
					<td class="ind">${form.swollenJoints_today}</td>	
					<td class="ind">${form.painfulJoints_today}</td>	
				</tr>	
				</c:forEach>							
			</table>
