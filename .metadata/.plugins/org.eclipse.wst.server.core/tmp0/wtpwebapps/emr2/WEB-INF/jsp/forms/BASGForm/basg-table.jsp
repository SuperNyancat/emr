...
<c:choose>
	...
	<ul class="ctrlBtn">
		<li><span class="btn"><a href="BASG_form_assembler.it?id=${patient.getId() }"><input type="button" value="New Record" class="btnNew"></a></span></li>
...
<div class="content-wrap">	
	<div class="wrapper prospects">
		...
		<div style="background:goldenrod">
				<br><p class="titles" style="color:white;">Bath Ankylosing Spondylitis Global Score (BAS-G)</p><br>		
		</div>
			<div class="tableSearch clrfix">
				<section>
					 <form:form commandName="patient" action="search_basg.it" method="GET">
				...
				<table class ="tablecontent3">	
						...
						<tr>
							...
							<th class="phn"><a href="">Total</a></td>
							<th class="ind"><a href="">BAS-G Score</a></td>
						</tr>
		...
		<c:if test="${errorMessage != null }">	
			...
			<tr>
				...
				<td class="pro"><a href="view_basg.it?pid=${patient.getId()}&fid=${form.getId()}">${ form.getRevisionHistory().getDateCreated()}</a></td>
				
				<td class="phn">${form.getTotal() }</td>
				<td class="ind">${form.getScore() }</td>
				</tr>
			</c:forEach>
		</table>
