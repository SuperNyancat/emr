...
<html lang="en">
<head>
	<title>Laboratory Request Forms</title>
	<meta charset="utf-8">
...
<c:choose>
	...
	<ul class="ctrlBtn">
		<li><span class="btn"><a href="laboratory_request_assembler.it?id=${patient.getId() }"><input type="button" value="New Record" class="btnNew"></a></span></li>
...
<div class="content-wrap">	
	<div class="wrapper prospects">
		...
		<div style="background:goldenrod">
				<br><p class="titles" style="color:white;">Laboratory Request Forms</p><br>		
		</div>
			<div class="tableSearch clrfix">
				<section>
				<form:form commandName="patient" action="search_lab_request.it" method="GET">
...
<table class="tablecontent3">		
		...
		<tr>
			...
			<c:forEach items="${labForms }" var="form">
				<tr>
				<td><div class="blue"></div></td>
				<td class="pro"><a href="view_lab_request.it?pid=${patient.getId()}&fid=${form.getId()}">${ form.getRevisionHistory().getDateCreated()}</a></td>
				
				<td class="phn">${form.getDiagnosis() }</td>
