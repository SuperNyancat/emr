					...
					<div class="right">
						<form:form class="crmForm" method="post" commandName="doctor" action="create_doctor.it?id=${adminUser.getId() }" >
							...
							<ul class="fields">
								...
								<li><label>License Number<span style="color:red;">*</span></label>:<form:input path="licenseNumber" /></li>
								<li><label>Occupation</label>:<form:input path="personInfo.occupation"  /></li>
								<li><label>Specialization<span style="color:red;">*</span></label>:<form:input path="specialization" required="true"/></li>
								<li><label>Date of Birth<span style="color:red;">*</span></label>:<input name="personInfo.dateOfBirth" required type="text" id="inputField" /></li>
								...
								<li><label>Phone Number<span style="color:red;">*</span></label>:<form:input path="personInfo.contacts[0].phoneNumber" pattern="(^\\+?[\\d]+(\\-?[\\d]+)*)*" autocomplete="off"/></li>
						...
						<section>
							...
							<ul class="fields">
								...
								<li><label>Password<span style="color:red;">*</span></label>:<form:password path="user.password" min="8" required="true" id="txtNewPassword" /></li>
							...
							<ul class="fields">
								...
								<li><label><strong>Office Hours</strong></label></li>
									<li><label>Start Time<span style="color:red;">*</span></label>: 
										<form:input path="officeStart" required="true"/>
										
									</li>
									<li><label>End Time<span style="color:red;">*</span></label>:
										<form:input path="officeEnd" required="true"/>
