...
<body>
	<div>
		<jsp:include page="../headers/admin-header.jsp">
			<jsp:param name="title" value="Create Doctor Account" />
			<jsp:param name="selected" value="doctors" />
		</jsp:include>
	</div>
	
    <!-- Page Content -->
  <form:form class="crmForm" method="post" commandName="doctor" action="create_doctor.it?id=${adminUser.getId() }" >
    <div class="div-left">
        ...
        <form:input path="suffix" class="form-control" placeholder="Suffix"/>
        ...
        <form:input type="text" path="personInfo.lastName" class="form-control" placeholder="Last Name" required="true"/>
            ...
            <form:input type="text" path="specialization" class="form-control" placeholder="Specialization" required="true"/>
            <br><br>
            <div class="form-group">
        <div class="date">
            ...
            <h3>CLINIC HOURS</h3>
                ...
                <form:input path="officeStart" required="true" class="form-control" placeholder="Start Time"/>
                <label for="text" class="sr-only">End Time</label>
                <form:input path="officeEnd" required="true" class="form-control" placeholder="End Time" />
                <br><br>
                <label for="text" class="sr-only">Phone Number</label>
