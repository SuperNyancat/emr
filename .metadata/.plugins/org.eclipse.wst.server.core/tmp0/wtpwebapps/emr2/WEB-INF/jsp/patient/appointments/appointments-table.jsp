...
<c:if test="${patient != null }">
	<ul class="ctrlBtn">
		<li><span class="btn"><a href="appointments_assembler.it?id=${patient.id }"><input type="button" value="New Record" class="btnNew"></a></span></li>
	</ul>
</c:if>
</div>
	...
	<div class="wrapper prospects">
		...
		<div class="tab-content">
			...
			<div class="tableSearch clrfix">
				<section>
					    <form:form commandName="patient" action="search_appointment.it" method="GET">
					    <c:if test="${patient != null }">
					...
					<table class="tablecontent3">	
							...
							<tr>
								...
								<th class="phn">Time Started</th>
								<th class="phn">Time Ended</th>
								<th class="ind">Title</th>
							</tr>
		...
		<tr>
			...
			<c:remove var="errorMessage" scope="session" /></td> 
							...
							<tr>
								...
								<td class="pro"><a href="view_appointment.it?pid=${form.getPatient().getId()}&fid=${form.getId()}">${ form.getRevisionHistory().getDateCreated()}</a></td>
								<td class="phn">${form.startTime}</td>
								<td class="ind">${form.endTime}</td>
								<td class="ind">${form.getTitle() }</td>
							</tr>	
							</c:forEach>							
						</table>
