			...
			<div class="right">
				<form:form action="das_create.it?id=${patient.id }" method="post" commandName="form">
					...
					<table border="1px" class="navigation" style="margin:0px auto;">	
						<tr>
							<td style="font-size:10px;width:130px;"><form:input size="1" maxlength="3" path="vas" /><b>: VAS (0-100)</b></td>
							...
							<td style="font-size:10px;width:130px;"><form:input size="1" maxlength="3" path="esr" /><b>: ESR</b></td>
						</tr>
